...
import com.example.udanthui.Customer;
...
public class FoodQueue {
    ...
    private static String filePath = "D:\\Files\\customer.txt";
    ...
    public static void mymethod104(int cnum){
        ...
        // Check if the chosen cashier number is 2
            ...
            if(cashierTWO[0] != null) {
                System.out.println("Customer Served.");
                burgersStock -= cashierTWO[0].getBurgers();// Subtract 5 from BurgerStock
